...
var obj = findObjectByKey(stationCodes.response, 'code', 'EWR');

console.log('Your airport name is: ' + obj.name);




// console.log(codeNames.response[0].Code) //"4O"
// if (codeNames.response[0].Code == 'AAA') {
// console.log('your airport is: ' + stationCodes.response[0].name);
// }
  ...
  //                 "key": {
  //     "id": 11034,
  //       "api_key": "9edc36d4-5a61-4e7b-8a6a-7d2f8daf0d7f",
  //         "type": "free",
  //           "expired": null,
  //             "registered": "2018-04-12T01:09:21.000Z",
  //               "limits_by_hour": 2500,
